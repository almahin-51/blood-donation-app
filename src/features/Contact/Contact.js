  ...
  return (
    <div onClick={handleClick}>
      <div
        ...
        style={{
          backgroundImage:
            "url(https://image.freepik.com/free-photo/businesswoman-looking-important-contact-phone_1163-4256.jpg)",
          width: "100%",
          height: "250px",
      ...
      <div className="container mx-auto py-10 px-5 lg:px-0">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="contact-box hover:shadow-lg transition-all duration-300 rounded shadow-md text-center p-5">
