    ...
    return (
        <div className='slide-bg hero-area'>
            <div className="hero-text text-center">
                ...
                <button className='bg-red-500 text-white px-12 hover:text-red-500 hover:bg-white border-2 border-transparent hover:border-red-500 transition-all duration-300 py-3 rounded-full mt-10'>Donate Blood</button>
            </div>
        </div>
    );
};
