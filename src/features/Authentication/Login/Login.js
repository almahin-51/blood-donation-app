...
const Login = () => {
    ...
    const { loginUser, error, signInWithGoogle } = useAuth()
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
                    <div className="login-form">
                        ...
                        <form onSubmit={handleLoginSubmit}>
                            <input onChange={takeLoginInput} className='lg:w-3/4 w-full mb-4 h-12 pl-5 focus:outline-none border-b-2 border-red-400 rounded-full' type="email" placeholder='Enter your email' required name='email' /> <br />
                            <input onChange={takeLoginInput} className='lg:w-3/4 w-full mb-4 h-12 pl-5 focus:outline-none border-b-2 border-red-400 rounded-full' type="password" name='password' placeholder='Enter your password' /> <br />
