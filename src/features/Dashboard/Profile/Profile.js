      ...
      <div className="md:flex px-12 py-4 sm:space-x-16">
        <div className="img w-48 text-center mx-auto md:mx-0 mt-6 sm:mt-0">
          ...
          {donar?.group ? (
            ...
            <Link
              to="/become-donar"
              className="btn inline-block hover:bg-red-500 hover:text-white hover:border-red-500 mt-4 transition-all duration-300 font-semibold"
            >
              Become a Donar
            </Link>
          )}
        ...
        <div className="mt-4">
          ...
          <h1 className="text-lg">
            {donar?.phone || <small className="text-grey-300">Null</small>}
          </h1>
          <h3 className="font-bold text-gray-600 text-base mt-2">
            Blood Group
          </h3>
          <h1 className="text-lg uppercase">
            {donar?.group || <small className="text-grey-300">Null</small>}
          </h1>
        </div>
      </div>
    </div>
