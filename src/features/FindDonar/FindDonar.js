          ...
          <div className="col-start-2 col-span-4">
            <div className="donar-search-box">
              ...
              <input
                ...
                className="border-2 border-red-200 rounded-full focus:outline-none w-11/12 lg:w-3/5 h-8 lg:h-10 pl-5 pr-24"
                type="text"
                placeholder="Enter your area name"
              />
              <button
                onClick={handleDonarSubmit}
                className="bg-red-400 text-white px-4 lg:px-6 py-1 lg:py-2 lg:font-semibold rounded-full -ml-20 mt-1"
              >
...
>>>>>>> ec041635ebd6d9f4770ad35ddcbb2dfa500a49fa
            </div>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-center">
          {donar.map((data) => (
            <div
              key={data._id}
              className="single-donar rounded flex items-center p-2"
            >
              <img
              ...
              <div className="donar-text ml-5 text-left">
                ...
                <button
                  onClick={() => handleDonarContact(data.phone, data.email)}
                  className="bg-red-400 text-white font-semibold px-2 rounded mt-3"
                >
                  Contact Donar
                </button>
              </div>
